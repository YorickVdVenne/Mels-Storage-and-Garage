        ...
        <div className="relative w-full min-h-[80vh] max-h-[100rem] items-center grid grid-cols-10 gap-4">
          <div className="flex flex-col col-start-2 col-end-5">
            ...
            <p className="font-commons text-xl mt-4">
              Looking for a place to safely store your bike during the winters?
              Or while on vacations? You don&apost want to pay big bucks for
              storing at dealerships, come check out{' '}
              <span className="font-beckman text-xl leading-10 group">
                <span className="group-hover:text-red transition-colors duration-500">
                  Moto
                </span>
                <span className="text-red group-hover:text-white transition-all duration-500">
                  Mel
                </span>
              </span>
              !
